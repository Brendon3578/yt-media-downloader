...
export function Header() {
  ...
  return (
    <header className="sticky top-0 flex h-16 items-center gap-4 border-b bg-background/75 backdrop-blur-lg hover:bg-background md:justify-around px-4 md:px-6 shadow shadow-foreground/10 z-50 transition-colors">
